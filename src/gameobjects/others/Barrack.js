...
module.exports = class Barrack extends ExtendWTraits(GameObject, IHasTeam) {
	...
	constructor(options) {
		...
		UnitList.barracks[this.teamName][this.num] = this;
	...
	spawnUnitAns(unitNetId, minionType) {
		var Barrack_SpawnUnit = Server.network.createPacket('Barrack_SpawnUnit');
		...
		Server.teams.ALL.sendPacket(Barrack_SpawnUnit);

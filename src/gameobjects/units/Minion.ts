...
import Filters from '../extensions/Filters/index';
import MovingUnit from '../extensions/traits/MovingUnit';
import Player from './Player';
import { AttackableUnit, MinionOptions } from '../GameObjects';
...
export default class Minion extends Unit {
	 ...
	 * [teamId] (BLUE/RED)
	 * [laneId] (0/1/2 TOP/MID/BOT)
	 */
	moveLane(teamId: number | undefined = undefined, laneId: number | undefined = undefined) {
	...
	get rewardExp() {
		let character = this.character.constructor as _Minion;

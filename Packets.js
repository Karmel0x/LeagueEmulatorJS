...
Packets.cmd = {
	...
	C2S_HEART_BEAT:							{id: 0x08, channel: Packets.channels.CHL_C2S, packet: require('./Packets/0x08-C2S_HEART_BEAT.js')},
	...
	C2S_AUTO_ATTACK_OPTION:					{id: 0x47, channel: Packets.channels.CHL_C2S, packet: require('./Packets/0x47-C2S_AUTO_ATTACK_OPTION.js')},
	...
	S2C_BLUE_TIP:							{id: 0x55, channel: Packets.channels.CHL_S2C, packet: require('./Packets/0x55-S2C_BLUE_TIP.js')},
	...
	CHAT_BOX_MESSAGE:						{id: 0x68, channel: Packets.channels.CHL_COMMUNICATION, packet: require('./Packets/0x68-CHAT_BOX_MESSAGE.js')},
	...
	S2C_TURRET_SPAWN:						{id: 0x9D, channel: Packets.channels.CHL_S2C, packet: require('./Packets/0x9D-S2C_TURRET_SPAWN.js')},
	...
	S2C_GAME_TIMER:							{id: 0xC1, channel: Packets.channels.CHL_S2C, packet: require('./Packets/0xC1-S2C_GAME_TIMER.js')},
	S2C_GAME_TIMER_UPDATE:					{id: 0xC2, channel: Packets.channels.CHL_S2C, packet: require('./Packets/0xC2-S2C_GAME_TIMER_UPDATE.js')},
	...
	S2C_LEVEL_PROP_SPAWN:					{id: 0xD0, channel: Packets.channels.CHL_S2C, packet: require('./Packets/0xD0-S2C_LEVEL_PROP_SPAWN.js')},
	...
	S2C_DEBUG_MESSAGE:						{id: 0xF7, channel: Packets.channels.CHL_S2C, packet: require('./Packets/0xF7-S2C_DEBUG_MESSAGE.js')},

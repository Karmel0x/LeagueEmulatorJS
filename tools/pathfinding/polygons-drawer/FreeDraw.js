...
(window, function () {
	return function (e) {
		var t = window.webpackHotUpdateFreeDraw;
		window.webpackHotUpdateFreeDraw = function (e, i) {
			!function (e, t) {
				if (!b[e] || !k[e])
					return;
				for (var i in k[e] = !1, t)
		...
		function g(t) {
			...
			for (var N, j, M = w.slice(); M.length > 0; )
				if (l = M.pop(), h = C[l]) {
					var B = {},
	...
	([function (e, t, i) {
				...
				var l = function () {
					...
					(i = [{
								...
								value: function (e, t, i) {
									var n = "M".concat(e[0], ",").concat(e[1], "L").concat(t[0], ",").concat(t[1]),
									r = new Path2D(n);
								...
								value: function (e, t) {
									...
									r = void 0;
									try {
										for (var o, s = this.temporaryPointsWithoutZoomAndOffset[Symbol.iterator](); !(i = (o = s.next()).done); i = !0) {
											var a = o.value;
											if (e === a[0] && t === a[1])
												return !1
										}
								...
								value: function (e, t) {
									var i = !1;
									if (this.edit) {
										for (var n = null, r = 0; r < this.handlePoints.length; r++)
				...
				var v = function (e) {
					...
					(n = [{
								...
								value: function () {
									for (var e = 0; e < this.handlePoints.length; e++)
								...
								value: function (e) {
									...
									if (this.clickedHandlePoint) {
										var n = this.handlePoints[this.clickedHandlePointIndex].point;
								...
								value: function () {
									...
									var i = Number(((this.startPoint[0] - this.freeDraw.transformCenter[0]) * this.freeDraw.zoomLevel + this.freeDraw.transformCenter[0]).toFixed(this.freeDraw.fix)),
				...
				var b = function (e) {
					...
					(n = [{
								...
								value: function () {
									for (var e = 0; e < this.handleLines.length; e++)
										this.handleLines[e].obj = this._drawLine(this.handleLines[e].startPoint, this.handleLines[e].endPoint, a)
								}
							}, {
								key: "getZoomAndMove",
								value: function () {
									var e = Number((this.radiusX * this.freeDraw.zoomLevel).toFixed(this.freeDraw.fix)),
								...
								key: "_toSVGPath",
								value: function () {
									var e = Number(this.x.toFixed(this.freeDraw.fix)),
				...
				var O = function (e) {
					...
					(n = [{
								...
								value: function () {
									for (var e, t, i, n, r = this.getZoomAndMove(), o = 0; o < r.length; o++)
								...
								value: function () {
									...
									i = void 0;
									try {
										for (var n, r = this.handlePoints[Symbol.iterator](); !(e = (n = r.next()).done); e = !0) {
											var o = n.value;
								...
								value: function (e) {
									...
									if (this.clickedHandlePoint)
										...
										s = void 0;
										try {
											for (var a, h = this.points[Symbol.iterator](); !(r = (a = h.next()).done); r = !0) {
												var l = a.value;
								...
								value: function (e) {
									...
									for (var n = 0; n < i.length; n++) {
										var r = Number(((i[n][0] - this.freeDraw.transformCenter[0]) * this.freeDraw.zoomLevel + this.freeDraw.transformCenter[0]).toFixed(this.freeDraw.fix)),
								...
								key: "getPath",
								value: function () {
									var e = "M" + this.getZoomAndMove(!0 === this.edit).map(function (e) {
										return e.join(",")
									}).join("L");
				...
				var I = function () {
					...
					(i = [{
								...
								value: function (e) {
									...
									if ("view" === this.model) {
										if ("keydown" === t)
											return;
										if ("mousedown" === t)
											for (var r in this.shapeInCanvas) {
												var o = this.shapeInCanvas[r];
												if (o._includes(i, n))
										...
										if (this.eventsCallBack && "function" == typeof this.eventsCallBack)
											for (var s in this.shapeInCanvas) {
										...
										var a = this.shapeInCanvas[this.editingId];
								...
								value: function () {
									for (var e in this._clearCanvas(), this.shapeInCanvas)
								...
								value: function (e) {
									...
									a = e.height;
									if (e.transform) {
										var h = this.removeZoomAndMoveRect(s, a, o);
										s = h.width,
										a = h.height,
										o = h.startPoint
									}
								...
								value: function (e) {
									...
									h = e.radiusY;
									if (e.transform) {
										var l = this.removeZoomAndMoveEllipse(o, s, a, h);
										o = l.x,
										s = l.y,
										a = l.radiusX,
										h = l.radiusY

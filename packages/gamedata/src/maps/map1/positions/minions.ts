import { LaneId, TeamId } from '@repo/gameserver/src/gameobjectextensions/traits/team';
import type { BarrackOptions } from '@repo/gameserver/src/gameobjects/spawners/barrack';

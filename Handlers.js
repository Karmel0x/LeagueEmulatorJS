...
var Handlers = {
	...
	0x0A: {handler: require('./Handlers/0x0A-UNPAUSE_GAME.js')},
	...
	0x3A: {handler: require('./Handlers/0x3A-USE_OBJECT.js')},
	...
	0x5D: {handler: require('./Handlers/0x5D-OnShopOpened.js')},
	0x6D: {handler: require('./Handlers/0x6D-BLUE_TIP_CLICKED.js')},
	...
	0x8D: {handler: require('./Handlers/0x8D-ClientFinished.js')},
	0x8F: {handler: require('./Handlers/0x8F-EXIT.js')},
	0x92: {handler: require('./Handlers/0x92-WORLD_SEND_GAME_NUMBER.js')},
	0x9A: {handler: require('./Handlers/0x9A-CAST_SPELL.js')},
	0x9C: {handler: require('./Handlers/0x9C-SoftReconnect.js')},
	0xA1: {handler: require('./Handlers/0xA1-PAUSE_GAME.js')},
	0xA4: {handler: require('./Handlers/0xA4-SURRENDER.js')},
	...
	0xCC: {handler: require('./Handlers/0xCC-OnTutorialPopupClosed.js')},
	0xCD: {handler: require('./Handlers/0xCD-QUEST_CLICKED.js')},
	0xD6: {handler: require('./Handlers/0xD6-OnRespawnPointEvent.js')},
	0xE6: {handler: require('./Handlers/0xE6-SPELL_CHARGE_UPDATE.js')},
	0xEA: {handler: require('./Handlers/0xEA-SpectatorDataReq.js')},
	0xF4: {handler: require('./Handlers/0xF4-PlayContextualEmote.js')},
	0xFB: {handler: require('./Handlers/0xFB-TeamBalanceVote.js')},
	0x0106: {handler: require('./Handlers/0x0106-UnitSendDrawPath.js')},
	0x010A: {handler: require('./Handlers/0x010A-UndoItemReq.js')},
